...
func NewModuleNameFromString(s string) (ModuleName, error) {
	...
	case "CRLF_INJECTION":
		return ModuleNameCrlfInjection, nil
	case "PATH_TRAVERSAL":
...
func (w *WebServerReport) UnmarshalJSON(data []byte) error {
	type unmarshaler WebServerReport
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*w = WebServerReport(value)
...
func (w *WebServerTypeConfig) UnmarshalJSON(data []byte) error {
	type unmarshaler WebServerTypeConfig
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*w = WebServerTypeConfig(value)
